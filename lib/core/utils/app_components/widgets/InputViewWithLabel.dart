...
class InputViewWithLabel extends StatelessWidget{
  ...
  InputViewWithLabel({required this.subview,required this.nameOfField});
  ...
  Widget build(BuildContext context) {
    return SizedBox(height: 70,
      child: Stack(
        children: [
          Container(height: 50,margin: const EdgeInsets.fromLTRB(0, 10, 0, 0),padding: EdgeInsets.fromLTRB(0, 7, 0, 0),decoration: BoxDecoration(
