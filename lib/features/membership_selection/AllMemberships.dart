...
class AllMemberships extends StatefulWidget{
  final List<MemberShipsResponse> memberShips;

  AllMemberships({required this.memberShips});

  @override
  State<AllMemberships> createState() => _AllMembershipsState();
}

class _AllMembershipsState extends State<AllMemberships> {

  @override
  Widget build(BuildContext context) {
    return ViewContainer(title: StringsManager.memberShips,body: Container(alignment: Alignment.center,
      child:Column(children: [
        Expanded(child: ListView(padding: EdgeInsets.zero,shrinkWrap: false, children: [
        ...
        Padding(
            ...
            child: DefaultButton(
              ...
              function: () {
                ...
                sbRequest.IdentityNumber = CacheHelper.getData(key: 'identity');
                if(memberShips.length>1) {
                  sbRequest.Gender = memberShips[0].Gender;
                  sbRequest.IdentityNumber = CacheHelper.getData(key: 'identity');
                }
                GoRouter.of(context).push(AppRouters.kSelectCompanyScreen,extra: sbRequest);
              },
              text: StringsManager.add_membership,
              redius: 32,
            ))
