...
class CustomStepOneAppBar extends StatelessWidget {
  const CustomStepOneAppBar({super.key});
                      ...
                      children: [
                        ...
                        CircleAvatar(
                          ...
                          child: Padding(
                            ...
                            child: Text('3' , style: Styles.textStyle16W400.copyWith(color: const Color(0xFFDDDDDD))),
                          ),
                        ),
                      ],
                    ),
                    ...
                    const SizedBox(
                      ...
                      children: [
                        ...
                        CircleAvatar(
                          ...
                          child: Padding(
                            padding: const EdgeInsets.only(top: 5.0),
                            child: Text('2' , style: Styles.textStyle16W400.copyWith(color: const Color(0xFFDDDDDD))),
                          ),
                        ),
                      ],
                    ),
