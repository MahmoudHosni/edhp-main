...
import 'package:edhp/models/hospitals_level_entity.dart';
...
class HospitalsDataCubit extends Cubit<HospitalsDataStates> {
  ...
  List<HospitalsLevelEntity> levels = [HospitalsLevelEntity(id: 0, name: '')];
  ...
  _getLevels() {
    DioHelper.getData(
      ...
      (levels) {
        ...
        this.levels =
            levelsList.map((i) => HospitalsLevelEntity.fromJson(i)).toList();
