...
import 'package:edhp/features/medical_network/medical_centers_data/labs/labs_data_cubit.dart';
...
class LabsDataScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => LabsDataCubit(),
      child: BlocBuilder<LabsDataCubit, LabsDataStates>(
        builder: (context, state) {
          LabsDataCubit cubit = LabsDataCubit.get(context);
