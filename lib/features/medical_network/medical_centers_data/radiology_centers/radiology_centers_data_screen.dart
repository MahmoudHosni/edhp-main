...
import 'package:edhp/features/medical_network/medical_centers_data/radiology_centers/radiology_centers_data_cubit.dart';
...
class RadiologyCentersDataScreen extends StatelessWidget {
  const RadiologyCentersDataScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => RadiologyCentersDataCubit(),
      child: BlocBuilder<RadiologyCentersDataCubit, RadiologyCentersDataStates>(
        builder: (context, state) {
          RadiologyCentersDataCubit cubit =
              RadiologyCentersDataCubit.get(context);
