    ...
    return BlocConsumer<GetProfileCubit, GetProfileState>(
      ...
      builder: (context, state) {
        ...
        if (state is GetProfileSuccessfullyState ||
            state is GetProfileImageSuccessfullyState ||
            cubit.profileImage != null) {
          return ViewContainer(
            title: StringsManager.personalProfile,
            body: Container(
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    ConfirmDataFieldAndValueItem(
                        field: 'الإسم',
                        value: cubit.userProfileModel!.profileName!.toString()),
                    ConfirmDataFieldAndValueItem(
                        field: 'اسم المستخدم',
                        value: cubit.userProfileModel!.userName!.toString()),
                    ConfirmDataFieldAndValueItem(
                        field: 'رقم الهاتف',
                        value:
                            cubit.userProfileModel!.mobileNumber!.toString()),
                    ConfirmDataFieldAndValueItem(
                        field: 'البريد الالكتروني',
                        value: cubit.userProfileModel!.email!.toString()),
                    (cubit.userProfileModel!.identityNumber ?? '').length > 2
                        ? ConfirmDataFieldAndValueItem(
                            field: 'الرقم القومي',
                            value: cubit.userProfileModel!.identityNumber
                                .toString())
                        : SizedBox(),
                    ConfirmDataFieldAndValueItem(
                        field: 'النوع',
                        value: cubit.userProfileModel!.gender! == 1
                            ? 'ذكر'
                            : 'انثى'),
                    SizedBox(
